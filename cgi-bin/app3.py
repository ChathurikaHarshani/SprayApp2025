...
#     response = make_response(render_template('user_Main.html', json=jsonFile, orgowner=orgowner))

#     #response.set_cookie('username', username)
#     session['jsonFile'] = jsonFile

#     # print(jsonFile)
#     #response.set_cookie('json',jsonFile)
#     #response.set_cookie('pestApps',pestApps)

#     #session['pestApps'] = str(pestApps)
#     return response
...
def inviteUser():
    ...
    try:
        ...
        if(emailalreadysent is False):
            ...
            plain_password = ''.join(random.choice(characters) for i in range(12))
            ...
            if editaccess == '1':
                userTask.execute_insert_update_delete_query(connection,sql_query,[form['email'],form['email'],password,'Active','1','0','0'])
            else:
                userTask.execute_insert_update_delete_query(connection,sql_query,[form['email'],form['email'],password,'Active','0','0','0'])
