...
def select_userID_by_password_and_email_query():
    select_userID_by_password_and_email_query = "SELECT SQL_NO_CACHE User_ID FROM User_Info WHERE `Password`=%s AND `Email`=%s"
    return select_userID_by_password_and_email_query
