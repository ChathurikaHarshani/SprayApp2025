...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-I/home/qeuxdjhlf266/.python/include" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  ...
  LDFLAGS => [ "-L/home/qeuxdjhlf266/.python/lib" ],
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
  ...
  prefix => "/home/qeuxdjhlf266/.python",
  processor => "",
